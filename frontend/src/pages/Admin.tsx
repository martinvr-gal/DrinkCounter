import { useState } from "react"; import { useGesture } from "@use-gesture/react"; import { useMutation, useQuery, useQueryClient } from "@tanstack/react-query"; import { api, imageUrl, pending, updateStatus } from "../services/api"; import type { Photo, Status } from "../types";
